...
export default function LoginPage() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const dstUrl = params.get('link-orig') || 'https://nuanu.com/'
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-start gap-3 p-4 bg-blue-50/50 rounded-2xl border border-blue-100/50 group transition-colors hover:bg-blue-50">
                            ...
                            <label htmlFor="terms" className="text-[11px] leading-relaxed text-gray-600 font-medium cursor-pointer select-none">
                                I agree to the <span className="text-blue-600 font-bold">Terms of Service</span> and consent to receive marketing updates from Nuanu WiFi.
                            </label>
                        </div>
                        ...
                        <div className="space-y-6 pt-6 border-t border-gray-50">
                            ...
                            <div className="grid grid-cols-2 gap-4 uppercase font-black text-[10px] tracking-widest">
                                {settings.google_login_enabled === 'true' && (
                                    <a href="/auth/google/login" className="flex items-center justify-center gap-3 py-4 rounded-2xl border-2 border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-all group active:scale-95 shadow-sm">
                                ...
                                {settings.facebook_login_enabled === 'true' && (
                                    <a href="/auth/facebook/login" className="flex items-center justify-center gap-3 py-4 rounded-2xl border-2 border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-all group active:scale-95 shadow-sm">
